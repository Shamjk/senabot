function intro_calcular() {
    ...
    intro.setOptions({
        steps: [
            ...
            {
                element: document.getElementById(''),
                intro: '<div class="btn bg-white mb-0 subtitulos"><br><strong><h4 class="text-success">Formato F023 Momento N°2 (Seguimiento) Versión 6</h4></strong><br><audio autoplay class="audio-intro" controls><source src="audios/f023-01_v5/f023-2_intro.wav" type="audio/mpeg"></audio></div><img class="senabot-img" src="imagenes/undraw/senabot.png" width="280px" alt=""">',
                step: 0,
                position: 'right',
                x: 100, // Coordenada X
                y: 0, // Coordenada Y
            },
            {
                ...
                intro: '<div class="btn mb-0 subtitulos"><audio autoplay class="audio-intro" controls><source src="audios/f023-02_v5/f023-2-inicio.wav" type="audio/mpeg"></audio></div>', step: 1
            },
            {
                element: document.getElementById('intro2'),
                intro: '<div class="btn mb-0 subtitulos"><audio autoplay class="audio-intro" controls><source src="audios/f023-02_v5/f023-2_1.wav" type="audio/mpeg"></audio></div>', step: 2
            },
            {
                element: document.getElementById('intro3'),
                intro: '<div class="btn mb-0 subtitulos"><audio autoplay class="audio-intro" controls><source src="audios/f023-02_v5/f023-2_2.wav" type="audio/mpeg"></audio></div>', step: 3
            },
            {
            ...
            },
            {
                ...
                intro: '<div class="btn mb-0 subtitulos"><audio autoplay class="audio-intro" controls><source src="audios/f023-02_v5/f023-2_firma.wav" type="audio/mpeg"></audio></div>', step: 13
            },
